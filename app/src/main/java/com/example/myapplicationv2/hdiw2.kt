...
class hdiw2 : Base() {  // Hérite de Base au lieu de AppCompatActivity

    override fun getLayoutId(): Int {
        return R.layout.activity_hdiw2  // Retourne le layout spécifique à cette activité
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnImgRulesRight.setOnClickListener {
            val intent = Intent(this, hdiw3::class.java)
